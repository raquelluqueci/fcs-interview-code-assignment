...
### Build & testes de um módulo

Cada módulo (`java-assignment`, `java-assignment-architect`, `java-assignment-senior`) é um
projeto Maven independente. Usando `mvn -f <pom.xml>`, funciona a partir da raiz do repositório:
